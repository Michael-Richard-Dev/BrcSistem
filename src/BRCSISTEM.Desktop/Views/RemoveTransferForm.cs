...
{
    public sealed partial class RemoveTransferForm : Form
    {
        ...
        private DocumentMaintenanceHeader _transferHeader;
        ...
        public RemoveTransferForm(CompositionRoot compositionRoot, UserIdentity identity, DatabaseProfile databaseProfile)
        {
        ...
        {
            Text = "BRCSISTEM - Remover Transferencia";
        ...
        private Control BuildSearchArea()
        {
            ...
            row.Controls.Add(CreateFieldLabel("Numero da Transferencia:"));
            ...
            row.Controls.Add(CreateButton("Buscar", (sender, args) => SearchTransfer()));
        ...
        private Control BuildGridArea()
        {
            ...
            _headerGrid.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "CAMPO", DataPropertyName = "Field", Width = 240, SortMode = DataGridViewColumnSortMode.NotSortable });
            ...
            _itemsGrid.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "MATERIAL", DataPropertyName = nameof(DocumentMaintenanceItem.Material), Width = 300, SortMode = DataGridViewColumnSortMode.NotSortable });
            _itemsGrid.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "LOTE", DataPropertyName = nameof(DocumentMaintenanceItem.Lot), Width = 220, SortMode = DataGridViewColumnSortMode.NotSortable });
        ...
        private Control BuildButtons()
        {
            ...
            _removeButton = CreateButton("Remover Transferencia", (sender, args) => ConfirmRemoval());
