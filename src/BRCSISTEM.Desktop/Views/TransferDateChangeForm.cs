...
{
    public sealed partial class TransferDateChangeForm : Form
    {
        ...
        private DocumentDateEntry[] _transfers;

        private ComboBox _transferComboBox;
        private TextBox _newDateTextBox;
        private DataGridView _detailsGrid;
        private Label _statusLabel;

        public TransferDateChangeForm(CompositionRoot compositionRoot, UserIdentity identity, DatabaseProfile databaseProfile)
        {
            ...
            _transfers = Array.Empty<DocumentDateEntry>();
        ...
        {
            Text = "BRCSISTEM - Alterar Data de Transferencia";
            ...
            {
                AutoSize = true,
                Text = "Alterar Data de Transferencia",
        ...
        {
            var group = new GroupBox { Dock = DockStyle.Top, AutoSize = true, Text = "Selecionar Transferencia", Font = new Font("Segoe UI", 10F, FontStyle.Bold) };
            ...
            _transferComboBox = new ComboBox
            {
                Width = 360,
                DropDownStyle = ComboBoxStyle.DropDownList,
                Font = new Font("Segoe UI", 10F),
            };
            _transferComboBox.SelectedIndexChanged += (sender, args) => UpdateDetails();
            line1.Controls.Add(_transferComboBox);
            line1.Controls.Add(CreateButton("Atualizar", (sender, args) => LoadTransfers()));
        ...
        {
            var group = new GroupBox { Dock = DockStyle.Fill, Text = "Dados da Transferencia Selecionada", Font = new Font("Segoe UI", 10F, FontStyle.Bold) };
