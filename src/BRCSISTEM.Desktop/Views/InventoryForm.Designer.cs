...
namespace BRCSISTEM.Desktop.Views
{
    public sealed partial class InventoryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.BuildRootLayout());
        ...
        private Control BuildHeaderPanel()
        {
            ...
            _numberTextBox = new TextBox { Dock = DockStyle.Top, ReadOnly = true, Font = new Font("Segoe UI", 10F), Name = "_numberTextBox" };
            ...
            _createdTextBox = new TextBox { Dock = DockStyle.Top, ReadOnly = true, Font = new Font("Segoe UI", 10F), Name = "_createdTextBox" };
            line1.Controls.Add(_createdTextBox, 5, 0);
            line1.Controls.Add(CreateFieldLabel("Programado:"), 6, 0);
            _scheduledTextBox = new TextBox { Dock = DockStyle.Top, Font = new Font("Segoe UI", 10F), Name = "_scheduledTextBox" };
            ...
            _maxPointsNumeric = new NumericUpDown
            {
                Minimum = 1,
                Maximum = 20,
                Value = 1,
            ...
            _observationTextBox = new TextBox { Dock = DockStyle.Top, Font = new Font("Segoe UI", 10F), MaxLength = 40, Name = "_observationTextBox" };
        ...
        private Control BuildPlanningPanel()
        {
            ...
            _onlyBrcCheckBox = new CheckBox
            {
                AutoSize = true,
                Text = "Somente BRC",
                Font = new Font("Segoe UI", 9F),
                Margin = new Padding(18, 10, 0, 0),
                Name = "_onlyBrcCheckBox",
            };
        ...
        private Control BuildCenterPanel()
        {
            var split = new SplitContainer
            {
                ...
                Name = "_centerSplitContainer",
            };

            var itemsGroup = new GroupBox
            {
                Dock = DockStyle.Fill,
                Text = "Itens do Inventario",
                Font = new Font("Segoe UI", 10F, FontStyle.Bold),
                Name = "_itemsGroup",
            };
            ...
            var rightRoot = new TableLayoutPanel { Dock = DockStyle.Fill, RowCount = 3, ColumnCount = 1, Name = "_rightRootLayout" };
            ...
            var pointActions = new FlowLayoutPanel { Dock = DockStyle.Fill, Padding = new Padding(0, 8, 0, 8), WrapContents = true, Name = "_pointActionsFlow" };
