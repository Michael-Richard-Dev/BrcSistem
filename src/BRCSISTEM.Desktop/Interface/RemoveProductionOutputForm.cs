...
{
    public sealed partial class RemoveProductionOutputForm : Form
    {
        ...
        private DocumentMaintenanceHeader _outputHeader;
        ...
        public RemoveProductionOutputForm(CompositionRoot compositionRoot, UserIdentity identity, DatabaseProfile databaseProfile)
        {
        ...
        {
            Text = "BRCSISTEM - Remover Saida de Producao";
            ...
            {
                AutoSize = true,
                Text = "Remover Saida de Producao",
        ...
        private Control BuildSearchArea()
        {
            ...
            row.Controls.Add(CreateButton("Buscar", (sender, args) => SearchOutput()));
        ...
        private Control BuildGridArea()
        {
            ...
            _itemsGrid.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "LOTE", DataPropertyName = nameof(DocumentMaintenanceItem.Lot), Width = 160, SortMode = DataGridViewColumnSortMode.NotSortable });
        ...
        private Control BuildButtons()
        {
            ...
            _removeButton = CreateButton("Remover Saida", (sender, args) => ConfirmRemoval());
            _removeButton.Enabled = false;
            panel.Controls.Add(_removeButton);
            panel.Controls.Add(CreateButton("Fechar", (sender, args) => Close()));
