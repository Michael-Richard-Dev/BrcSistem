...
{
    internal sealed class LoteSelecaoData
    {
        private readonly LookupOption[] _opcoes;

        public LoteSelecaoData(LookupOption[] opcoes)
        {
            _opcoes = opcoes ?? new LookupOption[0];
        }

        public IReadOnlyList<LoteSelecaoItem> Listar()
        {
            return _opcoes
                .Where(o => o != null)
                .Select(o => new LoteSelecaoItem
                {
