...
namespace BRCSISTEM.Domain.Catalog
{
    public static class LegacyModuleCatalog
    {
        public static ModuleDefinition[] Create()
        {
            return new[]
            {
                new ModuleDefinition("cadastro_fornecedor", "Cadastros", "Fornecedores", "cadastro_fornecedor", "views/cadastro_fornecedor.py", "Cadastro de fornecedores de materiais.", false),
                new ModuleDefinition("cadastro_embalagem", "Cadastros", "Embalagens", "cadastro_embalagem", "views/cadastro_embalagem.py", "Cadastro base de materiais e embalagens.", false),
                ...
                new ModuleDefinition("cadastro_almoxarifado", "Cadastros", "Almoxarifados", "cadastro_almoxarifado", "views/cadastro_almoxarifado.py", "Cadastro e manutencao dos almoxarifados.", false),
                ...
                new ModuleDefinition("movimentacao_saida_producao", "Movimentacoes", "Saida de Producao", "movimentacao_saida_producao", "views/movimentacao_saida_producao.py", "Baixa de materiais para producao com FIFO.", false),
                new ModuleDefinition("movimentacao_requisicao", "Movimentacoes", "Requisicao de Materiais", "movimentacao_requisicao", "views/movimentacao_requisicao.py", "Reserva e atendimento de requisicoes.", false),
                new ModuleDefinition("movimentacao_inventario", "Inventario", "Inventario de Estoque", "movimentacao_inventario", "views/movimentacao_inventario.py", "Abertura, contagem e fechamento de inventarios.", false),
                new ModuleDefinition("conta_corrente_estoque", "Consultas e Relatorios", "Conta Corrente de Estoque", "conta_corrente_estoque", "views/conta_corrente_estoque.py", "Extrato analitico das movimentacoes de estoque.", false),
                new ModuleDefinition("resumo_sintetico", "Consultas e Relatorios", "Resumo Sintetico", "resumo_sintetico", "views/resumo_sintetico.py", "Resumo gerencial consolidado do estoque.", false),
                new ModuleDefinition("relatorio_movimentacao_estoque", "Consultas e Relatorios", "Movimentacao de Estoque", "relatorio_movimentacao_estoque", "views/relatorio_movimentacao_estoque.py", "Filtros e consultas detalhadas de movimentos.", false),
                new ModuleDefinition("relatorio_entrada_pdf", "Consultas e Relatorios", "Relatorio de Entrada (PDF)", "relatorio_entrada_pdf", "views/relatorio_entrada_pdf.py", "Geracao de PDF de entradas.", false),
                ...
                new ModuleDefinition("cadastro_usuario", "Parametros", "Cadastro de Usuarios", "cadastro_usuario", "views/cadastro_usuario.py", "Cadastro de usuarios do sistema.", false),
                new ModuleDefinition("tipo_usuario", "Parametros", "Tipos de Usuario (Permissoes)", "tipo_usuario", "views/tipo_usuario.py", "Configuracao de perfis e permissoes.", false),
