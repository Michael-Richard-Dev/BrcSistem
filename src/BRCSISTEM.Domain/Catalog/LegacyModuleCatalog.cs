    ...
    public static class LegacyModuleCatalog
    {
        public static ModuleDefinition[] Create()
        {
            return new[]
            {
                ...
                new ModuleDefinition("consulta_nota_entrada", "Consultas e Relatorios", "Consultar Nota Entrada", "consulta_nota_entrada", "views/movimentacao_entrada.py", "Consulta de notas fiscais de entrada.", true),
                ...
                new ModuleDefinition("relatorio_producao_saida_pdf", "Consultas e Relatorios", "Relatorio de Producao - Saida (PDF)", "relatorio_producao_saida_pdf", "views/relatorio_producao_saida_pdf.py", "Geracao de PDF para saidas de producao.", true),
                new ModuleDefinition("relatorio_transferencia_pdf", "Consultas e Relatorios", "Relatorio de Transferencias (PDF)", "relatorio_transferencia_pdf", "views/relatorio_transferencia_pdf.py", "Geracao de PDF para transferencias.", true),
                new ModuleDefinition("relatorio_inventario_pdf", "Consultas e Relatorios", "Relatorio de Inventario (PDF)", "relatorio_inventario_pdf", "views/relatorio_inventario_pdf.py", "Geracao de PDF para inventarios.", true),
                ...
                new ModuleDefinition("bd_remover_transferencia", "Banco de Dados", "Remover Transferencia", "bd_remover_transferencia", "views/bd_remover_transferencia.py", "Exclusao controlada de transferencias.", true),
                new ModuleDefinition("bd_remover_saida", "Banco de Dados", "Remover Saida", "bd_remover_saida", "views/bd_remover_saida.py", "Exclusao controlada de saidas.", true),
