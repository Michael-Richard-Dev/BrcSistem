...
namespace BRCSISTEM.Domain.Models
{
    public sealed class InventoryDetail
    {
        ...
        {
            Items = Array.Empty<InventoryItemDetail>();
            Points = Array.Empty<InventoryPointSummary>();
            Counts = Array.Empty<InventoryCountSummary>();
        }
        ...
        public InventoryItemDetail[] Items { get; set; }

        public InventoryPointSummary[] Points { get; set; }

        public InventoryCountSummary[] Counts { get; set; }
        ...
        public string ScheduledAtDisplay
        {
            get { return FormatDateTime(ScheduledAt); }
        }
