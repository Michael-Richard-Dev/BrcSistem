...
{
    public sealed class ProductionOutputReportEntry
    {
        ...
        {
            get { return QuantitySent.ToString("N2", PtBr); }
        }

        public string QuantityReturnedText
        {
            get { return QuantityReturned.ToString("N2", PtBr); }
        }

        public string QuantityConsumedText
        {
            get { return QuantityConsumed.ToString("N2", PtBr); }
        }
    }
}
